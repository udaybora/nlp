...
import com.swabunga.spell.event.TeXWordFinder;
	...
	class NewSpellChecker implements SpellCheckListener {
	static float spellCheckPercentage= 0 , grammarCheckPercentage = 0;
	static String reviewMessage = ""; 
	
	
	private SpellChecker spellChecker; //spellChecker2;
	 ...
	 private static SpellDictionaryHashMap dictionaryHashMap;//dictionaryHashMap2;
	  
	 static{
	  
	  File dict = new File("C:/Users/BUDAY/Downloads/elsveir project/dictionary.txt");
	  //File dict2 = new File("dictionary/dictionary.txt");
	  try {
	   dictionaryHashMap = new SpellDictionaryHashMap(dict);
	   //dictionaryHashMap2 = new SpellDictionaryHashMap(dict2);
	 ...
	 private void initialize(){
	   ...
	   //spellChecker2 = new SpellChecker(dictionaryHashMap2);
	   //spellChecker2.addSpellCheckListener(this);
	   
	 }
	  
	  
	 public NewSpellChecker() {
